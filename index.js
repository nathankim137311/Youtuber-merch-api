...
function insertProductData(products) {
    products.forEach(product => {
        db.query(
            'INSERT INTO YoutubeMerch (product_id, channel_id, name, price, img_src) VALUES (?, ?, ?, ?, ?)',
            [product.id, product.channelId, product.name, product.price, product.imgSrc],(err, result) => {
                if (err) {
                    console.log(err);
                }
            }
